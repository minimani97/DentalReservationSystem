                    ...
                    <ul class="metismenu side-nav">
                        ...
                        <li class="side-nav-item active">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">
                                <li>
                                    <a href="http://localhost:8090/reservation/admin">의료진관리</a>
                                </li>
                                <li>
                                    <a href="http://localhost:8090/reservation/admin2">환자관리</a>
                                </li>
                                <li>
                                    <a href="http://localhost:8090/reservation/admin3" class="active">병원관리/승낙</a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="c_table" class="table dt-responsive nowrap" width="100%">
                                            <thead>
                                            	<!-- <tr>
                                            		<th>예약자</th>
                                            		<th>생년월일</th>
