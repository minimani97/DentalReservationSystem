                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label>날짜 선택</label>
                                                    <input type="text" id="closeDate" class="form-control" data-provide="datepicker">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group mb-0">
                                                    <label>휴진 시작 시간</label>
                                                    <div class="input-group">
                                                        <input type="text" id="start_time" class="form-control" data-toggle='timepicker' data-show-meridian="false">
                                                ...
                                                <br>
                                                <div class="form-group mb-0">
                                                    <label>휴직 종료 시간</label>
                                                    <div class="input-group">
                                                        <input type="text" id="end_time" class="form-control" data-toggle='timepicker' data-show-meridian="false">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text"><i class="dripicons-clock"></i></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    <label>사유</label>
                                                    <textarea data-toggle="maxlength" id="reason" class="form-control" maxlength="225" rows="3" placeholder="휴진 사유를 입력하세요."></textarea>
                                                </div>
                                                <br><br>
                                                <button type="button" class="btn btn-primary btn-rounded" onclick="javascript:closeButton();" style="position: absolute; right:80px;">등록</button>
                                                <br>
                                            </div> <!-- end col -->
                                        </div>
