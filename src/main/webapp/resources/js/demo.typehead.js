$(document).ready(function() {
    ...
    $("#the-basics").typeahead({
        ...
        source: (o = e, function(e, a) {
            var t;
            t = [], substrRegex = new RegExp(e, "i"), $.each(o, function(e, a) {
    ...
    $("#default-suggestions").typeahead({
        ...
        source: t,
        templates: {
            empty: ['<div class="typeahead-empty-message">', "Unable to find any Best Picture winners that match the current query", "</div>"].join("\n"),
